...
class TestEnvBool:
    def test_env_bool_true_values(self):
        from assistant import env_bool
...
class TestCreateAssistant:
    ...
    @patch("assistant.RAG")
    @patch("assistant.get_query_rewriter")
    @patch("assistant.get_reranker")
...
class TestGetReranker:
    ...
    @patch("assistant.Reranker")
    @patch("assistant.os.path.exists", return_value=False)
    ...
    @patch("assistant.Reranker")
    @patch("assistant.os.path.exists", return_value=True)
    @patch.dict(os.environ, {"RERANKER_ENABLED": "true"})
    ...
    @patch("assistant.Reranker", side_effect=Exception("load error"))
    @patch("assistant.os.path.exists", return_value=True)
    @patch.dict(os.environ, {"RERANKER_ENABLED": "true"})
