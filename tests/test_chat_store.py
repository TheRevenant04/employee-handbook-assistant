...
class TestChatStoreInit:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    def test_init_starts_worker(self, mock_start):
...
class TestChatStoreCreateConversation:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_create_conversation_returns_id(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
    ...
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_create_conversation_with_default_title(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
...
class TestChatStoreAddMessage:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_add_message_returns_id(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
    ...
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_add_message_updates_conversation_timestamp(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
...
class TestChatStoreRecordMetrics:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    def test_record_metrics_inserts_row(self, mock_start):
        from src.services.chat_store import ChatStore
...
class TestChatStoreGetMessages:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_get_messages_returns_formatted_list(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
    ...
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    @patch("src.services.chat_store.get_connection")
    def test_get_messages_empty(self, mock_get_connection, mock_start):
        from src.services.chat_store import ChatStore
...
class TestChatStoreRateMessage:
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    def test_rate_message_invalid_raises(self, mock_start):
        from src.services.chat_store import ChatStore
    ...
    @patch("src.services.chat_store.BackgroundWorker._start_worker")
    def test_rate_message_submits_to_worker(self, mock_start):
        from src.services.chat_store import ChatStore
